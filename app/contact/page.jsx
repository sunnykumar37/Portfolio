      ...
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row gap-8 xl:gap-[30px]">
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form onSubmit={handleSubmit} className="flex flex-col gap-5 sm:gap-6 p-5 sm:p-8 xl:p-10 bg-[#27272c] rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                ...
                <Button type="submit" disabled={isSending} size="md" className="w-full sm:w-auto sm:max-w-40 px-10 py-2 bg-accent rounded-lg text-black">{isSending ? "Sending..." : "Send message"}</Button>
          ...
          <div className="flex-1 flex items-start xl:items-center xl:justify-end order-1 xl:order-none mb-0">
            <ul className="flex flex-col gap-10">
              {
                info.map((item, index) => {
                  return <li key={index} className="flex items-center gap-4 sm:gap-6">
